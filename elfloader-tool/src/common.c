                   ...
                   int max_user_images, int *num_images )
{
    ...
    paddr_t user_image_paddr = 0xb0000000;

    next_phys_addr = user_image_paddr;
    ...
    *num_images = 0;
    ...
    /*
    phys_region_start: ffffffffb0000000
    phys_region_end: ffffffffb0380000
    virt_region_start: 10000
    virt_region_end: 390000
    virt_entry: 3b7ce
    phys_virt_offset: ffffffffafff0000
    */
//#if 0
    user_info->phys_region_start = 0xb0000000;
    user_info->phys_region_end   = 0xb0380000;
    user_info->virt_region_start = 0x0000000000010000;
    user_info->virt_region_end   = 0x0000000000390000;
    user_info->virt_entry        = 0x000000000003b7ce;
    user_info->phys_virt_offset  = 0xffffffffafff0000;
//#endif
